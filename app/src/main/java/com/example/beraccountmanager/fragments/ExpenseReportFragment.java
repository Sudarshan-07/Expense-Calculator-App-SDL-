...
public class ExpenseReportFragment extends Fragment  implements LoaderManager.LoaderCallbacks<Cursor>,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.filter_records:
                View menuItemView = getActivity().findViewById(R.id.filter_records);
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.filter_by_today:
                makeTodaysReport();
                return true;
            case R.id.filter_by_week:
                makeWeeklyReport();
                return true;
            case R.id.filter_by_month:
                makeMonthlyReport();
                return true;
            case R.id.filter_by_date:
                makeDateReport();
                return true;
            case R.id.filter_by_date_range:
                makeDateRangeReport();
                return true;
            default:
                return false;
